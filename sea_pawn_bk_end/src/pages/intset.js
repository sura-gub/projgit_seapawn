...
function Intset() {
    ...
    const fetchPawnSettings = () => {
        ...
        fetch('http://localhost:5000/fetch-pawn-settings')
    ...
    const handleSubmit = () => {
        ...
        fetch('http://localhost:5000/update-pawn-settings', {
          method: 'POST',
          headers: {
                    ...
                    <div className='col-md-6 vh-100'>
                        <div className='col-md-9'>
                            <div className='fs-4 text-center'>
                                <b style={{ fontWeight: '400' }}>Pawn Setting Details</b>
                            </div>
                            <table className='table table-bordered border-gray text-center mt-3'>
                                <tbody>
                                    <tr>
                                        <td style={{backgroundColor: '#fff', fontWeight: '400'}} colSpan='2'><b>Pawn Interest :: </b>{pawnSettingDetails.pawnInterest} %</td>
                                    </tr>
                                    <tr>
                                        <td style={{backgroundColor: '#fff', fontWeight: '400'}}><b>Koottuvatti :: </b>{pawnSettingDetails.koottuvatti}</td>
                                        <td style={{backgroundColor: '#fff', fontWeight: '400'}}><b>Koottuvatti Interest :: </b>{pawnSettingDetails.koottuvattiInterest} %</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
